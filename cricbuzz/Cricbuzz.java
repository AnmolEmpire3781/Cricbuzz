...
import lld.cricbuzz.match.Match;
import lld.cricbuzz.match.MatchType;
import lld.cricbuzz.match.T20MatchType;
...
public class Cricbuzz {
    public static void main(String[] args) {
        ...
        Match match = new Match(teamA, teamB, null, "INDORE STADIUM", matchType);
        match.startMatch();
