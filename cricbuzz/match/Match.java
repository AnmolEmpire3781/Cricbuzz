...
import lld.cricbuzz.innings.InningDetail;
    ...
    public void startMatch() {
        ...
        for(int inning=1; inning<=2; inning++){
            ...
            if(inning == 1){
                ...
                inningDetails = new InningDetail(battingTeam, bowlingTeam, matchType);
